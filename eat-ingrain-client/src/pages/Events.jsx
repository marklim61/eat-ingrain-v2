...
const Events = () => {
  ...
  return (
    <>
      <div className="absolute inset-0 bg-cover bg-center bg-neutral-950 h-full w-full p-16 z-0">
        <div
      ...
      <div className="relative flex flex-col justify-center items-center">
        ...
        <EventTimer eventDate={new Date("2024-08-22T00:00:00")} setColor="bg-ingrain-color-orange"/>
